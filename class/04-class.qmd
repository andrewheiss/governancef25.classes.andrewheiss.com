...
- **Playing with actual governance-related data** ([see here for a full tutorial!](/assignment/data-exploration.qmd))
...
R code example: [Posit.cloud example](https://posit.cloud/content/10948821) (V-Dem doesn't work though)
