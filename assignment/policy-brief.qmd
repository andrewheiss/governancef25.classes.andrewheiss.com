...
- **Conclusions and recommendations**: Conclusions of your policy brief are specific and actionable recommendations that you want your readers to adopt (in case of an advocacy brief) or a summary of policy alternatives that policymakers should know (in the case of an objective brief) 
...
I will grade this project using this rubric. I *highly* recommend that you refer to the rubric when writing the essay!

- {{< fa list-check >}}&ensp;[`blank_policy-brief.xlsx`](/files/rubrics/blank_policy-brief.xlsx)
