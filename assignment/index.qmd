...
There are two assignments to help you with this:

- **Reading reports**: Before class on Thursdays, you should complete all the readings and write a short summary of what you read. **You should** [**follow this template and instructions**](/assignment/reading-report.qmd)**.** These are due by 11:59 PM on the day before class (e.g., the reading report for Thursday, September 4's seminar is due at 11:59 PM on Wednesday, September 5).

- **Check-in and warm-up**: At the beginning of class each week, you'll spend some time reporting your preparation and thinking/writing about the readings to help get warmed up for the discussion. [**See this for complete instructions and details.**](/assignment/check-in-warm-up.qmd)
...
- **Data-based essay**: Use data from the [OECD](https://data.oecd.org/), [World Bank](https://data.worldbank.org/), [Varieties of Democracy (V-Dem) project](https://www.v-dem.net/), or [Quality of Governance (QoG) project](https://www.gu.se/en/quality-government/qog-data) to compare some aspect of the public sector across five countries. [**Complete instructions and details for this assignment are here.**](/assignment/data-exploration.qmd)

- **Theory in real life essay**: Apply the theories and concepts from the readings to a specific real-world issue. [**Complete instructions and details for this assignment are here.**](/assignment/theory-in-real-life.qmd)


## Final project

For your [final project](/assignment/policy-brief.qmd), you will write a policy brief (3,000 words; including footnotes but excluding references). A policy brief is a concise summary of a particular issue, the policy options to deal with it, and some recommendations about the best option. In general, it is written for a non-specialized audience such as policymakers, NGO staff, journalists, and the general public. For this assignment, though, your policy brief readers are policymakers (politicians or civil servants). Assume that your readers do not have detailed knowledge about the topic/issue you explore. They are also not scientists or experts in the area of your choice. Assume that the policymakers are busy and they need to quickly understand your arguments.
...
[**Complete instructions and details for this assignment are here.**](/assignment/policy-brief.qmd)


## Exams

There are no exams! Read a bunch of things, write a bunch of things, participate in class. That's it.
